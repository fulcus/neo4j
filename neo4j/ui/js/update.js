...
$("#findPerson").click(function () {
  ...
  if (first_name != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "p.first_name='" + first_name + "'"
    );
  }
  if (last_name != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "p.last_name='" + last_name + "'"
    );
  }
  if (email != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "p.email='" + email + "'"
    );
  }
...
$("#findPlace").click(function () {
  ...
  if (name != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "p.name='" + name + "'"
    );
  }
  if (type != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "p.type='" + type + "'"
    );
  }
...
$("#findTest").click(function () {
  ...
  if (date != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "t.date='" + date + "'"
    );
  }
  if (outcome != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "t.outcome='" + outcome + "'"
    );
  }
...
$("#findVaccine").click(function () {
  ...
  if (date != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "v.date='" + date + "'"
    );
  }
  if (name != "") {
    set_command = set_command.concat(
      space_or_comma(set_command) + "v.name='" + name + "'"
    );
  }
...
$("#deletePerson").click(function () {
  ...
  if (cf != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.cf='" + cf + "'"
    );
  }
  if (first_name != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.first_name='" + first_name + "'"
    );
  }
  if (last_name != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.last_name='" + last_name + "'"
    );
  }
  if (email != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.email='" + email + "'"
    );
  }
...
$("#deletePlace").click(function () {
  ...
  if (id != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.id='" + id + "'"
    );
  }
  if (name != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.name='" + name + "'"
    );
  }
  if (type != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "p.type='" + type + "'"
    );
  }
...
$("#deleteTest").click(function () {
  ...
  if (id != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "t.id='" + id + "'"
    );
  }
  if (date != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "t.date='" + date + "'"
    );
  }
  if (outcome != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "t.outcome='" + outcome + "'"
    );
  }
...
$("#deleteVaccine").click(function () {
  ...
  if (id != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "v.id='" + id + "'"
    );
  }
  if (date != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "v.date='" + date + "'"
    );
  }
  if (name != "") {
    where_command = where_command.concat(
      space_or_and(where_command) + "v.name='" + name + "'"
    );
  }
